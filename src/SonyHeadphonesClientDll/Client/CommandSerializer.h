...
namespace CommandSerializer
{
	...
	*/
	...
	// Extract payload from a fully unescaped frame buffer (dataType+seq+sizeBE4+payload+checksum).
	// sizeBE4 gives the payload byte count; payload occupies [6, 6+size).
	...
	// Battery query payload: [COMMON_GET_BATTERY_LEVEL, BATTERY_INQUIRED_TYPE::BATTERY] = [0x10, 0x00]
